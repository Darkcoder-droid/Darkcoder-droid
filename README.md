...
```text
Shashank Kontikal
├── Role       →  Developer · Builder · Prototype Engineer
├── Interests  →  AI, IoT, Creative Tech
├── Hardware   →  M2 Air + iPhone 16
├── Location   →  Bengaluru, India
└── Status     →  Always building. Always learning.
```

> Passionate about impactful prototypes where **hardware meets intelligence** —  
> from sign language translation gloves to LoRa-based communication systems.
...
| 🧠 AI & Machine Learning | 🐍 Python Development | 📡 IoT Systems |
|:---:|:---:|:---:|
| Neural nets, model training & inference pipelines | FastAPI, PyTorch, data engineering | LoRa, edge devices & embedded intelligence |
